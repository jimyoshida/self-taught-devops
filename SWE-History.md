# Historic Events of Software Engineering

Most of the references are [Wikipedia English version](https://en.wikipedia.org/wiki/Main_Page).
...
Bash Initial release: June 8, 1989
...
CERN httpd Initial release: 24 December 1990
...
libwww Initial release: 1.0, November 1992
...
NCSA Mosaic Initial release: 0.5 / January 23, 1993
...
Netscape Navigator Initial release: 15 December 1994
...
CSS Initial release: 17 December 1996
...
XML First published: February 10, 1998
...
DOM First published: October 1, 1998
...
OpenSSL Initial release: 23 December 1998
...
VMware ESX Initial release: March 23, 2001
...
Arch Linux Initial release: 11 March 2002
...
Firefox Initial release: September 23, 2002
...
Nginx Initial release: 4 October 2004

Ubuntu is a Linux distribution based on Debian and composed mostly of free and open-source software.
Ubuntu Initial release: Ubuntu 4.10 (Warty Warthog) / 20 October 2004
...
Upstart Initial release: August 24, 2006
...
HTML5 Initial release: 22 January 2008
...
LXC Initial release: August 6, 2008
...
Chrome First release: 2 September 2008.

Open Virtualization Format (OVF) is an open standard for packaging and distributing virtual appliances or, more generally, software to be run in virtual machines.
OVF Initial release: September 2008
...
Docker Initial release: March 20, 2013
...
The Eclipse Foundation AISBL is an independent, Europe-based not-for-profit corporation that acts as a steward of the Eclipse open source software development community.
...
Terraform 1.0 release: June 08, 2021

Grafana acquired k6 in 2021.

Chocolatey 1.0.0 release: 18 Mar 2022
...
Since the source code of TeX is essentially in the public domain, other programmers are allowed to improve the system, but are required to use another name to distribute the modified TeX, meaning that the source code can still evolve.
...
Perl First appeared: December 18, 1987
...
Scala First appeared: 20 January 2004
...
Jinja Initial release: July 17, 2008
...
Kotlin First appeared: July 22, 2011
...
The Node.js Foundation was created in 2015 as a Linux Foundation project to accelerate the development of the Node.js platform.
